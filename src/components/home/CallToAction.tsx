        ...
        <div className="text-center">
          ...
          <div className="mb-12">
            ...
            <p className="text-xl text-purple-200 max-w-3xl mx-auto leading-relaxed">
              ...
              or simply connect with fellow tech enthusiasts. Let's create something extraordinary!
            </p>
          </div>
          ...
          <div className="flex flex-col sm:flex-row gap-6 justify-center mb-16">
            <Link
              to="/contact"
              className="group relative inline-flex items-center justify-center px-12 py-5 text-lg font-black text-purple-900 bg-white rounded-2xl overflow-hidden shadow-2xl hover:shadow-white/20 transition-all duration-300 transform hover:scale-105 hover:-translate-y-1"
            >
              <span className="absolute inset-0 w-full h-full bg-gradient-to-r from-purple-100 to-pink-100 opacity-0 group-hover:opacity-100 transition-opacity duration-300"></span>
          ...
          <div className="flex justify-center space-x-6">
            <a
              ...
              className="w-14 h-14 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white hover:bg-white/20 hover:scale-110 transition-all duration-300"
            >
            ...
            <a
              href="https://twitter.com/ShubhangiJ2811"
              target="_blank"
              rel="noopener noreferrer"
              className="w-14 h-14 rounded-full bg-white/10 backdrop-blur-md border border-white/20 flex items-center justify-center text-white hover:bg-white/20 hover:scale-110 transition-all duration-300"
            >
