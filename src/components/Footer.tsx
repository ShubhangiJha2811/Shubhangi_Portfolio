      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
          ...
          <div className="space-y-4">
            <h3 className="text-2xl font-bold">Shubhangi Jha</h3>
            <p className="text-gray-400 leading-relaxed">
              B-Tech IT Student & Full Stack Developer passionate about AI, Cybersecurity, and creating innovative digital solutions.
            </p>
          </div>
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center">
          <p className="text-gray-400">
            © {currentYear} Shubhangi Jha. All rights reserved. Built with React & Tailwind CSS.
          </p>
        </div>
      </div>
    </footer>
