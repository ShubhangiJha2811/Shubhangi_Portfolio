...
const ResumePage = () => {
  ...
  const languages = [
    { id: 'english', name: 'English', flag: '🇬🇧', file: 'Resume_Shubhangi.Jha_.pdf' },
    { id: 'hindi', name: 'हिंदी (Hindi)', flag: '🇮🇳', file: 'Resume_Shubhangi.Jha_.pdf' },
    { id: 'spanish', name: 'Español (Spanish)', flag: '🇪🇸', file: 'Resume_Shubhangi.Jha_.pdf' },
    { id: 'french', name: 'Français (French)', flag: '🇫🇷', file: 'Resume_Shubhangi.Jha_.pdf' },
    { id: 'german', name: 'Deutsch (German)', flag: '🇩🇪', file: 'Resume_Shubhangi.Jha_.pdf' },
    { id: 'japanese', name: '日本語 (Japanese)', flag: '🇯🇵', file: 'Resume_Shubhangi.Jha_.pdf' }
  ];
  ...
  return (
    <div className="pt-20 min-h-screen bg-gradient-to-b from-gray-50 to-white">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-24">
        ...
        {/* Note */}
        <div className="mt-12 bg-blue-50 border-l-4 border-blue-400 p-6 rounded-r-2xl">
          <div className="flex">
            ...
            <div className="ml-3">
              <p className="text-sm text-blue-700">
                <strong className="font-semibold">Note:</strong> The resume is currently available in English. You can view it online or download it for offline viewing. The document is regularly updated with the latest achievements and skills.
              </p>
            </div>
          </div>
        </div>
